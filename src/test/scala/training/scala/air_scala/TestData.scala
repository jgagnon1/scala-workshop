...
object TestData {
  ...
  val SFOToEWRDepartureEarly = new DateTime(2018, 6, 12, 9, 49, DateTimeZone.forID("US/Pacific"))
  ...
  val EWRToSFODepartureEarly = new DateTime(2018, 6, 21, 13, 15, DateTimeZone.forID("US/Eastern"))
  ...
  def SFToNewarkEarlySchedule = Schedule(
    FlightLeg(SFO, SFOToEWRDepartureEarly),
    FlightLeg(EWR, EWRToSFODepartureEarly)
  )
